    ...
    <div className="p-4 sm:p-6 md:p-8">
      ...
      <div className="bg-[#e7e7f0] rounded-lg shadow-md mt-6 p-6 sm:p-8">
        <div className="container mx-auto">
          <h1 className="mb-4 text-2xl font-bold sm:text-3xl">User Table</h1>
          <div className="flex flex-col mb-4 space-y-4 sm:flex-row xl:flex-row lg:flex-row md:flex-row sm:justify-between sm:items-center sm:space-y-0">
            <div className="flex flex-col items-start w-full sm:flex-row sm:space-x-4 sm:w-auto sm:items-center">
              ...
              <select
                className="w-full p-2 mt-2 transition duration-300 ease-in-out border rounded-lg sm:w-40 sm:mt-0 focus:outline-none focus:ring-2 focus:ring-blue-600"
                value={filter.role}
            ...
            <div className="flex items-center justify-center gap-3 pt-2 md:pt-0 sm:pt-0">
