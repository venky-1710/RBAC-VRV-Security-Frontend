              ...
              >
                ...
                <form onSubmit={handleSubmit} className="mt-5">
                      ...
                      {Object.keys(role.permissions).map((permissionKey) => (
                        ...
                        >
                          <input
                            ...
                            className="text-indigo-600 transition duration-300 form-checkbox"
                          />
                  ...
                  <div className="flex justify-end mt-6">
                    <button
                      type="submit"
                      className="px-3 py-2 text-sm tracking-wide text-white capitalize bg-[#003049] rounded-md hover:bg-indigo-600 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-50"
                    >
                      Add Role
                    </button>
                  </div>
